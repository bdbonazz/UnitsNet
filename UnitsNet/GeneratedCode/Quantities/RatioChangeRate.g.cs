...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return As(unitKey.ToUnit<RatioChangeRateUnit>());
        }
        ...
        internal static UnitKey GetUnitKey(string unitName)
        {
            switch(unitName)
            {
                case "DecimalFractionPerSecond": return UnitKey.ForUnit(RatioChangeRateUnit.DecimalFractionPerSecond);
                case "PercentPerSecond": return UnitKey.ForUnit(RatioChangeRateUnit.PercentPerSecond);

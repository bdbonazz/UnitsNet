...
namespace UnitsNet
{
        ...
        IFormattable
    {
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<ElectricCurrentDensity> IQuantityOfType<ElectricCurrentDensity>.QuantityInfo => Info;
        ...
        {
            return As(unitKey.ToUnit<ElectricCurrentDensityUnit>());
        }
